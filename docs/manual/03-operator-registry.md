...
4. [Agents list](registry-ui/agents-list.md) — registry members, current-page filters, pagination
...
10. [Routed tasks](registry-ui/tasks.md) — routed work cards and parent conversation links
