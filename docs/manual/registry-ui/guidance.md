...
Use the provider selector to switch between guidance surfaces such as **Claude** and **Codex**. The page shows the current **lifecycle badge**, the **draft system prompt body**, and operator controls for **save draft**, **preview**, **submit**, and **publish**.
