...
window.Kit = (() => {
    ...
    const DICT = {
        ...
        'protocol.stage.inputs.label': 'Needs from earlier steps',
        'protocol.stage.inputs.help': 'Check the shared files or text this step reads before it can run.',
        'protocol.stage.outputs.label': 'Produces for later steps',
        'protocol.stage.outputs.help': 'Check the shared files or text this step should create or update for later steps.',
        ...
        'protocol.artifact.kind.label': 'What it represents',
        'protocol.artifact.kind.help': 'Choose whether this shared output lives in the workspace or stays in the run record.',
