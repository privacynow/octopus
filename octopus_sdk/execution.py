...
async def _execute_request_locked(
    ...
    *,
    ...
    if result.cancelled:
        ...
        return RequestExecutionOutcome(status="cancelled", working_dir=str(result.working_dir or resolved.working_dir or ""))
    ...
    if result.returncode != 0:
        ...
        return RequestExecutionOutcome(
            ...
            working_dir=str(result.working_dir or resolved.working_dir or ""),
        )
