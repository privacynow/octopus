"""SDK-owned runtime-skill import and update workflows."""
...
class RuntimeSkillImportUseCases(RuntimeSkillImportPort):
    ...
    def __init__(
        ...
        *,
        ...
        guidance_service: ProviderGuidanceServicePort,
    ...
    def update_all(
        ...
        *,
        ...
        return tuple(
            ...
            if result.ok
            else RuntimeSkillMutationOutcome(name=result.name, ok=result.ok, message=result.message)
