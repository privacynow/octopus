...
echo "Done. Start the bot with: docker compose --project-directory . -f infra/compose/docker-compose.yml --profile bot --env-file .env.bot up -d bot  (or ./scripts/app/guided_start.sh)"
