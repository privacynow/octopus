...
BOT_PROVIDER="$provider" docker compose --profile bot --env-file .env.bot run --rm -e "BOT_PROVIDER=$provider" bot-provider sh /app/scripts/provider/container_provider_login.sh
